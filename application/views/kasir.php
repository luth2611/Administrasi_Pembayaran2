...
<li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url()."transaksi/SPP"?>"><i class="fa fa-cart-plus"></i>Bayar SPP</a></li>
            <li><a href="<?php echo base_url()."transaksi/raudoh"?>"><i class="fa fa-cart-plus"></i>Bayar Raudoh</a></li>
            <li><a href="<?php echo base_url()."transaksi/seragam"?>"><i class="fa fa-cart-plus"></i>Bayar Seragam</a></li>
            <li><a href="<?php echo base_url()."transaksi/majalah"?>"><i class="fa fa-cart-plus"></i>Bayar Majalah</a></li>
            <li><a href="<?php echo base_url()."transaksi/porseni"?>"><i class="fa fa-cart-plus"></i>Bayar Porseni</a></li>
   ...
   <div class="btn-group">
  <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Jenis Pembayaran
  </button>
  <div class="dropdown-menu">
    <a class="dropdown-item" href="#">SPP</a>
    <a class="dropdown-item" href="#">Bayar Hutang Pak RT</a>
    <a class="dropdown-item" href="#">Bayar daging</a>
    <div class="dropdown-divider"></div>
    <a class="dropdown-item" href="#">Bayar dosa</a>
  </div>
</div>
 </div>
